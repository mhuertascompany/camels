...
class simba_todo_tf(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self) -> tfds.core.DatasetInfo:   #https://www.tensorflow.org/datasets/api_docs/python/tfds/core/DatasetInfo
        ...
        return tfds.core.DatasetInfo(
            ...
            features=tfds.features.FeaturesDict({
                ...
                'HI': tfds.features.Tensor(shape=(256, 256, 1), dtype=tf.float32),
                'MgFe': tfds.features.Tensor(shape=(256, 256, 1), dtype=tf.float32),
                'P': tfds.features.Tensor(shape=(256, 256, 1), dtype=tf.float32),
                'omega_m': tf.float32,
                'sigma_8': tf.float32,
                "A_sn1": tf.float32,
                "A_agn1": tf.float32,
